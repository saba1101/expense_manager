...
<template>
    <div class="customize-overlay">
        <div class="customize-popup">
            ...
            <ul class="avatar">
                <li @click="select_avatar(a)" v-for="(a, ind) in avatars" :key="ind"
            ...
            <swiper :slides-per-view="1" class="card_slides" :centered-slides="true" :loop="false"
                :pagination="{ clickable: false }" navigation>
